...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('student_accounts', function (Blueprint $table) {
            ...
            $table->date('date');
            $table->string('type');
            $table->foreignId('fee_invoice_id')->nullable()->references('id')->on('fee_invoices')->onDelet('cascade'); 
            $table->foreignId('receipt_id')->nullable()->references('id')->on('receipt_students')->onDele('cascade');       
